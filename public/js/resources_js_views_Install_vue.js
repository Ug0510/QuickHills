...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Install.vue?vue&type=template&id=ca351768&scoped=true":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Install.vue?vue&type=template&id=ca351768&scoped=true ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", {
    staticClass: "auth",
    style: {
      backgroundImage: "url(" + _vm.$baseUrl + "/images/panel_login_background_img.jpg" + ")"
    }
  }, [_c("div", {
    staticClass: "login-wrapper"
  }, [_c("div", {
    staticClass: "auth-section col-lg-6 mt-5"
  }, [_c("div", {
  ...
  }, [_vm._l(_vm.requirements["requirements"], function (requirement, type) {
    return _c("table", {
      staticClass: "table"
    }, [_c("thead", [_c("tr", [_c("th", {
      staticClass: "ps-2"
    }, [_vm._v("PHP >= " + _vm._s(_vm.phpSupportInfo["minimum"]))]), _vm._v(" "), _c("th", {
      staticClass: "text-end pe-2"
    }, [_c("strong", [_vm._v(_vm._s(_vm.phpSupportInfo["current"]))]), _vm._v(" "), _c("i", {
      staticClass: "fa fa-fw",
      "class": _vm.phpSupportInfo["supported"] ? "fa-check-circle text-success" : "fa-exclamation-circle text-danger"
    })])])]), _vm._v(" "), _c("tbody", _vm._l(_vm.requirements["requirements"][type], function (enabled, extension) {
      return _c("tr", {
        "class": enabled ? "" : "text-danger"
      }, [_c("td", [_vm._v(_vm._s(extension))]), _vm._v(" "), _c("td", {
        staticClass: "text-end"
      }, [_c("i", {
        staticClass: "fa fa-fw",
        "class": enabled ? "fa-check-circle text-success" : "fa-exclamation-circle text-danger"
      })])]);
    }), 0)]);
  }), _vm._v(" "), _c("table", {
    staticClass: "table"
  ...
  }, [_vm._v("Permissions")])])]), _vm._v(" "), _c("tbody", [_vm._l(_vm.permissions["permissions"], function (permission) {
    return [permission["folder"] == ".env" ? [_c("tr", {
      "class": permission["permission"] ? "" : "text-danger"
    }, [_c("td", [_c("input", {
    ...
    }, [_c("strong", [_vm._v(_vm._s(permission["permission"] ? "" : _vm.__("The file is not writable!")))]), _vm._v(" "), _c("i", {
      staticClass: "fa fa-fw",
      "class": permission["permission"] ? "fa-check-circle text-success" : "fa-exclamation-circle text-danger"
    })])])] : [_c("tr", {
      "class": permission["isSet"] ? "" : "text-danger"
    }, [_c("td", [_c("input", {
      staticClass: "form-control",
      attrs: {
        type: "text",
      ...
      staticClass: "text-end align-middle"
    }, [_c("strong", [_vm._v(_vm._s(permission["permission"]))]), _vm._v(" "), _c("i", {
      staticClass: "fa fa-fw",
      "class": permission["isSet"] ? "fa-check-circle text-success" : "fa-exclamation-circle text-danger"
    })])])]];
  })], 2)])], 2), _vm._v(" "), _c("tab-content", {
    attrs: {
      title: "Database",
    ...
    staticClass: "text-center"
  }, [_vm._v("Below you should enter your database connection details. If you are not sure about these, contact your host.")]), _vm._v(" "), _c("form", [_c("div", {
    staticClass: "row"
  }, [_c("div", {
    ...
    on: {
      input: function input($event) {
        ...
        _vm.$set(_vm.database, "database_host", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.database, "database_port", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.database, "database_name", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
  ...
  }, [_vm._v("Database Username"), _c("span", {
    staticClass: "text-danger text-xs"
  }, [_vm._v("*")])]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.database, "database_username", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
  ...
  }, [_vm._v("Database Password"), _c("span", {
    staticClass: "text-danger text-xs"
  }, [_vm._v("*")])]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.database, "database_password", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "divider"
  ...
  }, [_vm._v("Admin Details")])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
  }, [_c("div", {
    staticClass: "form-group mb-3"
  }, [_c("label", {
    ...
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.database, "admin_email", $event.target.value);
      }
    }
  })])]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
  ...
  }, [_vm._v("Admin Password"), _c("span", {
    staticClass: "text-danger text-xs"
  }, [_vm._v("*")])]), _vm._v(" "), _c("div", {
    staticClass: "input-group"
  }, [(_vm.showAdminPassword ? "text" : "password") === "checkbox" ? _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    domProps: {
      checked: Array.isArray(_vm.database.admin_password) ? _vm._i(_vm.database.admin_password, null) > -1 : _vm.database.admin_password
    },
    on: {
      change: function change($event) {
        var $$a = _vm.database.admin_password,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && _vm.$set(_vm.database, "admin_password", $$a.concat([$$v]));
          } else {
            $$i > -1 && _vm.$set(_vm.database, "admin_password", $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.$set(_vm.database, "admin_password", $$c);
        }
      }
    }
  }) : (_vm.showAdminPassword ? "text" : "password") === "radio" ? _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.database.admin_password,
    ...
    domProps: {
      checked: _vm._q(_vm.database.admin_password, null)
    },
    on: {
      change: function change($event) {
        return _vm.$set(_vm.database, "admin_password", null);
      }
    }
  }) : _c("input", {
    directives: [{
    ...
    attrs: {
      ...
      required: "",
      autocomplete: "off",
      type: _vm.showAdminPassword ? "text" : "password"
    },
    domProps: {
      value: _vm.database.admin_password
    },
    on: {
      input: function input($event) {
        if ($event.target.composing) return;
        _vm.$set(_vm.database, "admin_password", $event.target.value);
      }
    }
  }), _vm._v(" "), _c("button", {
    ...
    on: {
      click: function click($event) {
        _vm.showAdminPassword = !_vm.showAdminPassword;
      }
    }
  }, [_vm.showAdminPassword ? _c("i", {
    ...
    attrs: {
      title: "Finish",
      "before-change": _vm.finish
    }
  }, [_c("div", {
    staticClass: "text-center"
  }, [_c("i", {
    staticClass: "fa fa-check-circle fa-5x text-success mx-auto my-3"
  }), _vm._v(" "), _c("h1", {
    staticClass: "text-success my-3"
  }, [_vm._v("Congratulations!")]), _vm._v(" "), _c("p", [_vm._v("Your website is ready now. Login to your Admin dashboard to make changes and modify any of the default content to suit your needs.")]), _vm._v(" "), _c("p", [_vm._v("Please come back and"), _c("a", {
  ...
  }, [_vm._v(" Leave a 5-star rating ")]), _vm._v(" if you are happy with this script.")]), _vm._v(" "), _c("small", {
    staticClass: "form-hint"
  }, [_vm._v("For security reasons, the system will remove the install link automatically.")])])]), _vm._v(" "), _vm.loadingWizard ? _c("div", {
    staticClass: "loader"
  }) : _vm._e(), _vm._v(" "), _vm.errorMsg ? _c("div", [_c("span", {
    staticClass: "error"
  }, [_vm._v(_vm._s(_vm.errorMsg))])]) : _vm._e()], 1)], 1)])])]);
};
var staticRenderFns = [];
