    ...
    downloadSellers: function downloadSellers() {
      ...
      axios.get(this.$apiUrl + '/sellers', {
        ...
        if (data && data.length > 0) {
          var ws = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'xlsx'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).json_to_sheet(data); // Convert the data to worksheet
          var wb = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'xlsx'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).book_new(); // Create a new workbook
          Object(function webpackMissingModule() { var e = new Error("Cannot find module 'xlsx'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).book_append_sheet(wb, ws, 'Sellers'); // Append sheet to workbook
          ...
          Object(function webpackMissingModule() { var e = new Error("Cannot find module 'xlsx'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(wb, fileName);
        } else {
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        {
                          staticClass:
                            "text-center d-flex justify-content-start mb-2 mt-0 pt-0",
                        },
                        [
                          _c(
                            "button",
