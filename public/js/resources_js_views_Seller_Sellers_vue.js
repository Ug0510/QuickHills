...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    downloadSellers: function downloadSellers() {
      var _this3 = this;
      this.isLoading = true;
      // Make an API call without pagination parameters to fetch all sellers
      axios.get(this.$apiUrl + '/sellers', {
        params: {
          filterStatus: this.filterStatus
          // You can add any other filtering parameters you are using
        }
      }).then(function (response) {
        _this3.isLoading = false;
        var data = response.data.data;

        // Check if we have data, then convert it to XLSX format
        if (data && data.length > 0) {
          var ws = xlsx__WEBPACK_IMPORTED_MODULE_1__.utils.json_to_sheet(data); // Convert the data to worksheet
          var wb = xlsx__WEBPACK_IMPORTED_MODULE_1__.utils.book_new(); // Create a new workbook
          xlsx__WEBPACK_IMPORTED_MODULE_1__.utils.book_append_sheet(wb, ws, 'Sellers'); // Append sheet to workbook

          // Generate the file name based on the filter
          var fileName = "sellers_".concat(_this3.filterStatus || 'all', ".xlsx");

          // Trigger download of the file
          xlsx__WEBPACK_IMPORTED_MODULE_1__.writeFile(wb, fileName);
        } else {
          _this3.showMessage('warning', __('No data available for export.'));
        }
      })["catch"](function (error) {
        _this3.isLoading = false;
        console.error("Error fetching data for download", error);
        _this3.showMessage('error', __('Error fetching data.'));
      });
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Seller/Sellers.vue?vue&type=template&id=3712b1fa":
/*!**************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Seller/Sellers.vue?vue&type=template&id=3712b1fa ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_c("h3", [_vm._v(_vm._s(_vm.__("manage_sellers")))])]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.__("manage_sellers")))])])])])]), _vm._v(" "), _c("div", {
    staticClass: "row"
  }, [_c("div", {
  ...
  }, [_c("h4", [_vm._v(_vm._s(_vm.__("sellers")))]), _vm._v(" "), _c("span", {
    staticClass: "pull-right"
  }, [_vm.$can("seller_create") ? _c("router-link", {
    directives: [{
      name: "b-tooltip",
  ...
  }, [_vm._v(_vm._s(_vm.__("add_seller")))]) : _vm._e()], 1)]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("Filter Seller by Status " + _vm._s(_vm.__("filter_seller_by_status")))]), _vm._v(" "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }, [_vm._v(" " + _vm._s(_vm.__("all")))]), _vm._v(" "), _c("option", {
    attrs: {
      value: "0"
    }
  }, [_vm._v(" " + _vm._s(_vm.__("registered")))]), _vm._v(" "), _c("option", {
    attrs: {
      value: "1"
    }
  }, [_vm._v(" " + _vm._s(_vm.__("approve")))]), _vm._v(" "), _c("option", {
    attrs: {
      value: "2"
    }
  }, [_vm._v(" " + _vm._s(_vm.__("not_approved")))]), _vm._v(" "), _c("option", {
    attrs: {
      value: "3"
    }
  }, [_vm._v(" " + _vm._s(_vm.__("deactivate")))]), _vm._v(" "), _c("option", {
    attrs: {
      value: "7"
    }
  }, [_vm._v(" " + _vm._s(_vm.__("removed")))])])])]), _vm._v(" "), _c("b-col", {
    attrs: {
      md: "3",
      "offset-md": "5"
    }
    ...
    staticClass: "text-center d-flex justify-content-start mb-2 mt-0 pt-0"
  }, [_c("button", {
    directives: [{
      name: "b-tooltip",
      rawName: "v-b-tooltip.hover",
    ...
    staticClass: "btn btn-primary btn_refresh",
    attrs: {
      title: _vm.__("download")
    },
    on: {
      click: _vm.downloadSellers
    }
  }, [_c("i", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(row) {
        ...
        }, [_vm._v(_vm._s(_vm.__("approved")))]) : row.item.status == 2 ? _c("label", {
      ...
      fn: function fn(row) {
        return [row.item.require_products_approval == 1 ? _c("label", {
          staticClass: "badge bg-success"
        }, [_vm._v("\n                                        " + _vm._s(_vm.__("yes")))]) : row.item.require_products_approval == 0 ? _c("label", {
          staticClass: "badge bg-danger"
        }, [_vm._v(" " + _vm._s(_vm.__("no")))]) : _vm._e()];
      }
    }, {
      key: "cell(actions)",
      fn: function fn(row) {
        return [_vm.$can("seller_update") ? _c("router-link", {
          directives: [{
            name: "b-tooltip",
            rawName: "v-b-tooltip.hover",
            modifiers: {
          ...
          on: {
            click: function click($event) {
              return _vm.deleteSeller(row.index, row.item.id);
            }
          }
        }, [_c("i", {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sellers_vue_vue_type_template_id_3712b1fa__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sellers_vue_vue_type_template_id_3712b1fa__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Sellers_vue_vue_type_template_id_3712b1fa__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Sellers.vue?vue&type=template&id=3712b1fa */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Seller/Sellers.vue?vue&type=template&id=3712b1fa");
