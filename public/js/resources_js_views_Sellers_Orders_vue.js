...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=script&lang=js":
/*!***************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=script&lang=js ***!
  \***************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    itemCurrentPage: function itemCurrentPage() {
      this.getOrders();
    },
  ...
  methods: {
    ...
    loadFilter: function loadFilter() {
      var saveddateRangeStartDateFilter = localStorage.getItem('dateRangeStartDateFilter');
      console.log(saveddateRangeStartDateFilter);
      if (saveddateRangeStartDateFilter && saveddateRangeStartDateFilter != null && moment__WEBPACK_IMPORTED_MODULE_1___default()(saveddateRangeStartDateFilter).isValid()) {
        this.dateRange.startDate = saveddateRangeStartDateFilter;
      }
      var saveddateRangeEndDateFilter = localStorage.getItem('dateRangeEndDateFilter');
      if (saveddateRangeEndDateFilter && saveddateRangeEndDateFilter != null && moment__WEBPACK_IMPORTED_MODULE_1___default()(saveddateRangeEndDateFilter).isValid()) {
        this.dateRange.endDate = saveddateRangeEndDateFilter;
      }
      var savedSeller = localStorage.getItem('sellerFilter');
      if (savedSeller) {
      ...
      var saveddateRangeStartDeliveryDateFilter = localStorage.getItem('dateRangeStartDeliveryDateFilter');
      if (saveddateRangeStartDeliveryDateFilter && moment__WEBPACK_IMPORTED_MODULE_1___default()(saveddateRangeStartDeliveryDateFilter).isValid()) {
        this.deliveryDateRange.startDate = saveddateRangeStartDeliveryDateFilter;
      }
      var saveddateRangeEndDeliveryDateFilter = localStorage.getItem('dateRangeEndDeliveryDateFilter');
      if (saveddateRangeEndDeliveryDateFilter && moment__WEBPACK_IMPORTED_MODULE_1___default()(saveddateRangeEndDeliveryDateFilter).isValid()) {
        this.deliveryDateRange.endDate = saveddateRangeEndDeliveryDateFilter;
      }
      var savedSearchFilter = localStorage.getItem('searchFilter');
      if (savedSearchFilter) {
        this.search = savedSearchFilter;
      }
    },
    clearDate: function clearDate() {
      this.dateRange.startDate = null, this.dateRange.endDate = null, localStorage.setItem('dateRangeStartDateFilter', this.dateRange.startDate);
      localStorage.setItem('dateRangeEndDateFilter', this.dateRange.endDate);
      this.getOrders();
    },
    clearDeliveryDate: function clearDeliveryDate() {
      this.deliveryDateRange.startDate = null, this.deliveryDateRange.endDate = null, localStorage.setItem('dateRangeStartDeliveryDateFilter', this.deliveryDateRange.startDate);
      localStorage.setItem('dateRangeEndDeliveryDateFilter', this.deliveryDateRange.endDate);
      this.getOrders();
    },
    getOrders: function getOrders() {
      ...
      var item_offset = (this.itemCurrentPage - 1) * this.itemPerPage;
      var param = {
        "startDate": this.dateRange.startDate != null && moment__WEBPACK_IMPORTED_MODULE_1___default()(this.dateRange.startDate).isValid() ? moment__WEBPACK_IMPORTED_MODULE_1___default()(this.dateRange.startDate).format('YYYY-MM-DD') : "",
        "endDate": this.dateRange.endDate != null && moment__WEBPACK_IMPORTED_MODULE_1___default()(this.dateRange.endDate).isValid() ? moment__WEBPACK_IMPORTED_MODULE_1___default()(this.dateRange.endDate).format('YYYY-MM-DD') : "",
        startDeliveryDate: this.deliveryDateRange.endDate != null && moment__WEBPACK_IMPORTED_MODULE_1___default()(this.deliveryDateRange.endDate).isValid() ? moment__WEBPACK_IMPORTED_MODULE_1___default()(this.deliveryDateRange.startDate).format('YYYY-MM-DD') : '',
        endDeliveryDate: this.deliveryDateRange.endDate != null && moment__WEBPACK_IMPORTED_MODULE_1___default()(this.deliveryDateRange.endDate).isValid() ? moment__WEBPACK_IMPORTED_MODULE_1___default()(this.deliveryDateRange.endDate).format('YYYY-MM-DD') : '',
        "status": this.status,
        offset: offset,
        limit: this.perPage,
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$sellerApiUrl + '/orders', {
        ...
        _this2.totalOrderRows = response.data.total;
        ...
        _this2.totalOrderItemRows = response.data.data.total_order_item;
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=template&id=3bbeeb7f&scoped=true":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=template&id=3bbeeb7f&scoped=true ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_vm._v("Order List")])])])])])]), _vm._v(" "), _c("section", {
    staticClass: "section"
  }, [_c("div", {
    staticClass: "card"
  ...
  }, [_vm._v("All Orders")]), _vm._v(" "), _vm._l(_vm.statuses, function (status) {
    return _c("option", {
      domProps: {
        value: status.id
      }
  ...
  })], 1), _vm._v(" "), _c("b-row", [_c("div", {
    staticClass: "col-md-4 text-success h6"
  }, [_vm._v("Total Amount :- " + _vm._s(_vm.$currency) + " " + _vm._s(_vm.total_amount))]), _vm._v(" "), _c("div", {
    staticClass: "col-md-4 text-success h6"
  }, [_vm._v("Total D.Chrg:- " + _vm._s(_vm.$currency) + " " + _vm._s(_vm.delivery_charge))]), _vm._v(" "), _c("div", {
    staticClass: "col-md-4 text-success h6"
  }, [_vm._v("Total Final Amount:- " + _vm._s(_vm.$currency) + " " + _vm._s(_vm.final_total))])]), _vm._v(" "), _c("b-row", [_c("b-col", {
    staticClass: "my-1",
    attrs: {
      md: "2"
    }
    ...
    scopedSlots: _vm._u([{
      ...
      key: "head(tax)",
      fn: function fn(row) {
        return [_vm._v("\n                                        " + _vm._s("Tax (" + _vm.$currency + ") (%)") + "\n                                    ")];
      }
    }, {
      key: "cell(is_credited)",
      fn: function fn(row) {
        return [row.item.is_credited ? _c("span", {
          staticClass: "badge bg-success"
        }, [_vm._v("Credited")]) : _c("span", {
      ...
      fn: function fn(row) {
        return [row.item.active_status == _vm.$received ? _c("span", {
          staticClass: "badge bg-primary"
        }, [_vm._v(_vm._s(row.item.active_status))]) : row.item.active_status == _vm.$pending ? _c("span", {
          staticClass: "badge bg-secondary"
        }, [_vm._v("Awaiting Payment")]) : row.item.active_status == _vm.$processed ? _c("span", {
          staticClass: "badge bg-info"
        }, [_vm._v(_vm._s(row.item.active_status))]) : row.item.active_status == _vm.$shipped ? _c("span", {
          staticClass: "badge bg-warning"
        }, [_vm._v(_vm._s(row.item.active_status))]) : row.item.active_status == _vm.$delivered ? _c("span", {
          staticClass: "badge bg-success"
        }, [_vm._v(_vm._s(row.item.active_status))]) : row.item.active_status == _vm.$returned || row.item.active_status == _vm.$cancelled ? _c("span", {
          staticClass: "badge bg-danger"
        }, [_vm._v(_vm._s(row.item.active_status))]) : _c("span", {
          staticClass: "badge bg-danger"
        }, [_vm._v("Not Found")])];
      }
    }, {
  ...
  }, [_vm._v("Total:- " + _vm._s(_vm.$currency) + " " + _vm._s(_vm.order_items_total_sum))])]), _vm._v(" "), _c("b-row", [_c("b-col", {
    staticClass: "my-1",
    attrs: {
      md: "2"
    }
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=style&index=0&id=3bbeeb7f&scoped=true&lang=css":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=style&index=0&id=3bbeeb7f&scoped=true&lang=css ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Orders_vue_vue_type_style_index_0_id_3bbeeb7f_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Orders.vue?vue&type=style&index=0&id=3bbeeb7f&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=style&index=0&id=3bbeeb7f&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Orders_vue_vue_type_style_index_0_id_3bbeeb7f_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Orders_vue_vue_type_template_id_3bbeeb7f_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Orders.vue?vue&type=template&id=3bbeeb7f&scoped=true */ "./resources/js/views/Sellers/Orders.vue?vue&type=template&id=3bbeeb7f&scoped=true");
/* harmony import */ var _Orders_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Orders.vue?vue&type=script&lang=js */ "./resources/js/views/Sellers/Orders.vue?vue&type=script&lang=js");
/* harmony import */ var _Orders_vue_vue_type_style_index_0_id_3bbeeb7f_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Orders.vue?vue&type=style&index=0&id=3bbeeb7f&scoped=true&lang=css */ "./resources/js/views/Sellers/Orders.vue?vue&type=style&index=0&id=3bbeeb7f&scoped=true&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Orders_vue_vue_type_template_id_3bbeeb7f_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _Orders_vue_vue_type_template_id_3bbeeb7f_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "3bbeeb7f",
  null
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Orders_vue_vue_type_template_id_3bbeeb7f_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Orders_vue_vue_type_template_id_3bbeeb7f_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Orders_vue_vue_type_template_id_3bbeeb7f_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Orders.vue?vue&type=template&id=3bbeeb7f&scoped=true */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=template&id=3bbeeb7f&scoped=true");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_Orders_vue_vue_type_style_index_0_id_3bbeeb7f_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Orders.vue?vue&type=style&index=0&id=3bbeeb7f&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Sellers/Orders.vue?vue&type=style&index=0&id=3bbeeb7f&scoped=true&lang=css");
