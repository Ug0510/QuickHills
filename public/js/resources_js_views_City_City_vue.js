    ...
    getRecords: function getRecords() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/cities', {
        ...
        if (error !== null && error !== void 0 && (_error$request = error.request) !== null && _error$request !== void 0 && _error$request.statusText) {
          var _error$request2;
          _this.showError(error === null || error === void 0 || (_error$request2 = error.request) === null || _error$request2 === void 0 ? void 0 : _error$request2.statusText);
...
var render = function render() {
  ...
  }, [_c("h4", [_vm._v(_vm._s(_vm.__("manage_cities")))]), _vm._v(" "), _c("span", {
  ...
  }, [_vm._v(_vm._s(_vm.__("add_new_city")))]) : _vm._e()], 1)]), _vm._v(" "), _c("div", {
  ...
  }, [_c("label", [_vm._v(_vm._s(_vm.__("total_records")) + ":- " + _vm._s(_vm.totalRows))]), _vm._v(",\n"), _vm._v(" "), _vm.totalRows > 0 ? _c("b-pagination", {
    staticClass: "my-0",
    attrs: {
