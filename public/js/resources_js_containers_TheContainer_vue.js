...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "d-flex flex-column align-items-center justify-content-center align-content-center flex-wrap",
    attrs: {
      to: "/"
    }
  }, [_vm.$appLogo != "" ? _c("img", {
    ...
    return [(item.role == true ? _vm.$role("Super Admin") && (item.name == "Role" || item.name == "System Users") : item.permission && _vm.$can(item.permission)) ? _c("li", {
      ...
      return [(sub.role ? _vm.$role("Super Admin") && (item.name === "Role" || item.name === "System Users") : sub.permission && _vm.$can(sub.permission)) ? _c("li", {
        key: sub.key,
    ...
    return [(item.role == true ? _vm.$role("Super Admin") && (item.name == "Role" || item.name == "System Users") : item.permission && _vm.$can(item.permission)) ? _c("div", [_c("button", {
  ...
  }, [_c("router-view")], 1), _vm._v(" "), _c("the-footer")], 1)], 1);
};
