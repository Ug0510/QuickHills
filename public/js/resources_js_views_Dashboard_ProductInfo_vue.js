...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_vm.type === "sold_out" ? _c("h3", [_vm._v("Sold Out Products")]) : _vm._e(), _vm._v(" "), _vm.type === "low_stock" ? _c("h3", [_vm._v("Low Stock Products")]) : _vm._e(), _vm._v(" "), _vm.type === "packet_products" ? _c("h3", [_vm._v("Packet Products")]) : _vm._e(), _vm._v(" "), _vm.type === "loose_products" ? _c("h3", [_vm._v("Loose Products")]) : _vm._e()]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("Sold Out Products")]) : _vm._e(), _vm._v(" "), _vm.type === "low_stock" ? _c("li", {
    staticClass: "breadcrumb-item active",
    attrs: {
      "aria-current": "page"
    }
  }, [_vm._v("Low Stock Products")]) : _vm._e(), _vm._v(" "), _vm.type === "packet_products" ? _c("li", {
    staticClass: "breadcrumb-item active",
    attrs: {
      "aria-current": "page"
    }
  }, [_vm._v("Packet Products")]) : _vm._e(), _vm._v(" "), _vm.type === "loose_products" ? _c("li", {
    staticClass: "breadcrumb-item active",
    attrs: {
      "aria-current": "page"
    }
  }, [_vm._v("Loose Products")]) : _vm._e()])])])])]), _vm._v(" "), _c("section", {
    staticClass: "section"
  }, [_c("div", {
    staticClass: "card"
  }, [_c("div", {
  ...
  }, [_vm._v("Sold Out Products List")]) : _vm._e(), _vm._v(" "), _vm.type === "low_stock" ? _c("h4", {
    staticClass: "card-title"
  }, [_vm._v("Low Stock Products List")]) : _vm._e(), _vm._v(" "), _vm.type === "packet_products" ? _c("h4", {
    staticClass: "card-title"
  }, [_vm._v("Packet Stock Products List")]) : _vm._e(), _vm._v(" "), _vm.type === "loose_products" ? _c("h4", {
    staticClass: "card-title"
  }, [_vm._v("Loose Stock Products List")]) : _vm._e(), _vm._v(" "), _c("span", {
  ...
  }, [_vm._v("Add New Product")])], 1)]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("Filter by Products Category")]), _vm._v(" "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.category,
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(row) {
        return [_vm._v("\n                                " + _vm._s(row.item.measurement + " " + row.item.short_code) + "\n                            ")];
      }
    }, {
      key: "cell(stock)",
      fn: function fn(row) {
        return [row.item.is_unlimited_stock ? _c("span", [_vm._v("Unlimited")]) : [_vm._v("\n                                    " + _vm._s(row.item.stock) + " "), row.item.stock_unit ? _c("span", [_vm._v(_vm._s(row.item.stock_unit))]) : _vm._e()]];
      }
    }, {
      key: "cell(status)",
      fn: function fn(row) {
      ...
      fn: function fn(row) {
        return [row.item.till_status == 0 ? _c("span", {
          staticClass: "badge bg-danger"
        }, [_vm._v("Not Applicable")]) : _vm._e(), _vm._v(" "), row.item.till_status == "received" ? _c("span", {
          staticClass: "badge bg-success"
        }, [_vm._v("Received")]) : _vm._e(), _vm._v(" "), row.item.till_status == "processed" ? _c("span", {
          staticClass: "badge bg-success"
        }, [_vm._v("Processed")]) : _vm._e(), _vm._v(" "), row.item.till_status == "shipped" ? _c("span", {
          staticClass: "badge bg-success"
        }, [_vm._v("Shipped")]) : _vm._e(), _vm._v(" "), row.item.till_status == "delivered" ? _c("span", {
          staticClass: "badge bg-success"
        }, [_vm._v("Delivered")]) : _vm._e()];
      }
    }, {
      key: "cell(actions)",
      fn: function fn(row) {
