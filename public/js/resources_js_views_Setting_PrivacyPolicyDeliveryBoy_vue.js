...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_c("label", [_vm._v(_vm._s(_vm.__("privacy_policy")))]), _vm._v(" "), _c("a", {
    directives: [{
      name: "b-tooltip",
    ...
    attrs: {
      href: _vm.$baseUrl + "/delivery-boy-privacy-policy",
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.policies, "privacy_policy_delivery_boy", $$v);
      },
    ...
    staticClass: "d-flex justify-content-between mb-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.__("term_conditions")) + " : ")]), _vm._v(" "), _c("a", {
    directives: [{
      name: "b-tooltip",
      rawName: "v-b-tooltip.hover",
      modifiers: {
    ...
    staticClass: "btn btn-sm btn-primary",
    attrs: {
      href: _vm.$baseUrl + "/delivery-boy-terms-conditions",
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.policies, "terms_conditions_delivery_boy", $$v);
      },
