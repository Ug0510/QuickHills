...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_c("h4", [_vm._v(_vm._s(_vm.__("countries")))]), _vm._v(" "), _c("span", {
  ...
  }, [_vm._v(_vm._s(_vm.__("add_country")))])], 1)]), _vm._v(" "), _c("div", {
    ...
    scopedSlots: _vm._u([{
      ...
      key: "cell(logo)",
      fn: function fn(row) {
        return [row.item.logo === "" ? _c("p", [_vm._v(" " + _vm._s(_vm.__("no_image")))]) : _c("img", {
          attrs: {
...
var render = function render() {
  ...
  return _c("b-modal", {
  ...
  }, [_vm._v(_vm._s(_vm.__("dial_code")) + " ")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.dial_code,
  ...
  }, [_vm._v(_vm._s(_vm.__("code")) + " ")]), _vm._v(" "), _c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.code,
    ...
    staticClass: "form-group"
  }, [_c("label", [_vm._v(_vm._s(_vm.__("logo")))]), _vm._v(" "), _c("p", {
