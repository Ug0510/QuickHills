...
var render = function render() {
  ...
  return _c("b-modal", {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function fn(_ref) {
        ...
        }, [_vm._v(_vm._s(_vm.modal_title) + " & Permission Access : "), _c("strong", [_vm._v(" " + _vm._s(_vm.printName) + " ")])]) : _c("h5", {
          staticClass: "modal-title"
  ...
  }, [_vm._v("Cancel")])], 1), _vm._v(" "), _vm._v(" "), _c("form", {
    ref: "my-form",
    on: {
  ...
  }, [_c("label", [_vm._v("Title")]), _vm._v(" "), _c("i", {
    ...
    staticClass: "table table-lg table-bordered"
    ...
    return _c("tr", [_c("th", {
      ...
      staticClass: "row"
    }, [_vm.id ? _vm._l(category.permissions, function (permission) {
      return _c("div", {
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_c("h4", [_vm._v("Role")]), _vm._v(" "), _c("span", {
    ...
    scopedSlots: _vm._u([{
      ...
      key: "cell(actions)",
      fn: function fn(row) {
        return [!_vm.nonDeleteAbleRoles.includes(row.item.name) ? _c("button", {
          directives: [{
            name: "b-tooltip",
            rawName: "v-b-tooltip.hover",
            modifiers: {
        ...
        })]) : _vm._e(), _vm._v(" "), !_vm.nonDeleteAbleRoles.includes(row.item.name) ? _c("button", {
          directives: [{
            name: "b-tooltip",
            rawName: "v-b-tooltip.hover",
            modifiers: {
