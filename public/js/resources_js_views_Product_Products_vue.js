  ...
  methods: {
    ...
    downloadProducts: function downloadProducts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products', {
        ...
        var ws = xlsx__WEBPACK_IMPORTED_MODULE_4__.utils.json_to_sheet(formattedData);
        var wb = xlsx__WEBPACK_IMPORTED_MODULE_4__.utils.book_new();
        xlsx__WEBPACK_IMPORTED_MODULE_4__.utils.book_append_sheet(wb, ws, 'Products');

        // Generate the Excel file and trigger the download
        xlsx__WEBPACK_IMPORTED_MODULE_4__.writeFile(wb, 'products.xlsx');
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_c("h3", [_vm._v(_vm._s(_vm.__("manage_products")))])]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v(_vm._s(_vm.__("manage_products")))])])])])]), _vm._v(" "), _c("div", {
    staticClass: "row"
  }, [_c("div", {
  ...
  }, [_c("h4", [_vm._v(_vm._s(_vm.__("products")))]), _vm._v(" "), _c("span", {
  ...
  }, [_vm._v(_vm._s(_vm.__("add_product")))])] : [_c("router-link", {
    directives: [{
      name: "b-tooltip",
      rawName: "v-b-tooltip.hover",
      modifiers: {
  ...
  }, [_vm._v(_vm._s(_vm.__("add_product")))])]], 2)]), _vm._v(" "), _c("div", {
  ...
  }), _vm._v(" " + _vm._s(_vm.__("delete_selected_products")))])])], 1)], 1)]), _vm._v(" "), _c("b-row", {
    staticClass: "mb-2"
  }, [_c("b-col", {
    attrs: {
      md: "2"
    ...
    staticClass: "box-title"
  }, [_vm._v(_vm._s(_vm.__("filter_products_by_status")) + " ")]), _vm._v(" "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }, [_vm._v("Not-Approved")])])]), _vm._v(" "), _vm.$roleSeller == _vm.login_user.role.name ? [_c("input", {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    scopedSlots: _vm._u([{
      ...
      key: "cell(stock)",
      fn: function fn(row) {
        return [row.item.is_unlimited_stock === 1 || row.item.is_unlimited_stock === "1" ? _c("span", [_vm._v("Unlimited")]) : [_vm._v("\n                                            " + _vm._s(Math.floor(row.item.stock)) + "\n                                        ")]];
      }
    }, {
      ...
      key: "cell(actions)",
      fn: function fn(row) {
        return [_c("div", [_vm.$roleSeller == _vm.login_user.role.name ? [_c("router-link", {
          directives: [{
            name: "b-tooltip",
            rawName: "v-b-tooltip.hover",
            modifiers: {
        ...
        })]) : _vm._e(), _vm._v(" "), _vm.$can("product_update") ? _c("router-link", {
          directives: [{
            name: "b-tooltip",
            rawName: "v-b-tooltip.hover",
            modifiers: {
