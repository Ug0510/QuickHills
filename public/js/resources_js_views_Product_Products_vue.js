  ...
  methods: {
    ...
    downloadProducts: function downloadProducts() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/products', {
        ...
        _this3.isLoading = false; // Hide loading indicator

        // Get all the products
        var productsToDownload = response.data.data.products;

        // Format the data to match the structure of the table
        var formattedData = productsToDownload.map(function (product) {
          return {
            ...
            'Name': product.name,
            'Image': product.image,
            // You can choose to leave this out or add a URL
            'Price': product.price,
            'Discounted Price': product.discounted_price,
            'Measurement': product.measurement,
            'Stock': product.stock,
            'Status': product.status === 1 ? 'Available' : 'Sold Out',
            'Indicator': _this3.getProductIndicator(product.indicator),
        ...
        Object(function webpackMissingModule() { var e = new Error("Cannot find module 'xlsx'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).book_append_sheet(wb, ws, 'Products');

        // Generate the Excel file and trigger the download
        Object(function webpackMissingModule() { var e = new Error("Cannot find module 'xlsx'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(wb, 'products.xlsx');
      })["catch"](function (error) {
        _this3.isLoading = false; // Hide loading indicator on error
        console.error('Error fetching products:', error);
        _this3.showMessage('error', 'Error fetching products.');
      });
    },
    // Helper function to map product indicator
    getProductIndicator: function getProductIndicator(indicator) {
      switch (indicator) {
        case 0:
          return 'None';
        case 1:
    ...
    getSubCategories: function getSubCategories() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(url).then(function (response) {
        ...
        _this4.subcategories = data.data;
      });
    },
    deleteRecord: function deleteRecord(index, id) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this5.$apiUrl + '/products/delete', postData).then(function (response) {
    ...
    updateStatusProduct: function updateStatusProduct(index, id) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this6.$apiUrl + '/products/change', postData).then(function (response) {
    ...
    allSelectCheckBox: function allSelectCheckBox() {
      ...
      if (this.all_select === false) {
        ...
        var selectedProducts = this.products.slice(startIndex, endIndex);
        selectedProducts.forEach(function (product) {
          _this7.selectedItems.push(product.product_variant_id);
        });
        ...
        this.displayProducts = this.products.slice((this.currentPage - 1) * this.perPage, this.currentPage * this.perPage);
      }
    },
      ...
      if (uniqueSelectedItems.length !== 0) {
        this.$swal.fire({
          ...
          if (result.value) {
            ...
            axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this8.$apiUrl + '/products/multiple_delete', postData).then(function (response) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Products_vue_vue_type_template_id_560efc7a__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Products_vue_vue_type_template_id_560efc7a__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Products_vue_vue_type_template_id_560efc7a__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Products.vue?vue&type=template&id=560efc7a */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Product/Products.vue?vue&type=template&id=560efc7a");
